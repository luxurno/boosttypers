...
class DownloadCompilerPassSpec extends ObjectBehavior
{
    private const DEFINITION = 'App\Bundle\DownloadBundle\Download\DownloadContext';
    private const TAGS = 'download_strategy';
    private const DEFINITION_ID = 'definition_id';


    public function it_is_initializable(): void
    {
        $this->shouldHaveType(DownloadCompilerPass::class);
    }

    public function it_should_add_method_call_when_definition_is_found(
